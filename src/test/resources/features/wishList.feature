...
Feature: Like Icon (Wish List) Scenario
  ...
  Scenario: Add Product to Wish List / TC003 -[US-5]
    ...
    Then The user should verify that the "eufy P1 Smart Scale Blue and Black" is added to the Wish List
  ...
  Scenario: Add Product to Cart From Wish List / TC005 -[US-5]
    ...
    Then The user verifies that the "eufy P1 Smart Scale Blue and Black" is displayed in the cart page
